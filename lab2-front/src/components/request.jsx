...
function requestInfoToComponent(requestInfo, onStatusChange) {
	...
	return <RequestInfo
		...
		message={requestInfo.statusMessage}
		requestId={requestInfo.id}
		passportId={requestInfo.userId}
		manufacturer={requestInfo.car.manufacturer}
		model={requestInfo.car.model}
		startDate={requestInfo.startDate}
		days={requestInfo.days}
		cost={requestInfo.car.uahPerDay * requestInfo.days}
